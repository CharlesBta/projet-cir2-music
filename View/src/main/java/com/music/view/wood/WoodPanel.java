...
public class WoodPanel extends JLayeredPane implements KeyListener, FocusListener {

    private static final String[] WOOD_NOTES = {"Wood1", "Wood2", "Wood3", "Wood4", "Wood5", "Wood6", "Wood7", "Wood8"};
    ...
    private void initializeBits() {
        ...
        for (int i = 0; i < WOOD_NOTES.length; i++) {
            JButton bit = createBit(WOOD_NOTES[i]);
            gbc.gridx = i;
            add(bit, gbc);
        }
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.gridwidth = WOOD_NOTES.length; // Span across all columns
        add(noteLabel, gbc);
    }
